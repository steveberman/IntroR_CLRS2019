...
devMethod <- function(triangle, paidTri, tail=1, wtdAvg=rep(FALSE, ncol(triangle)-1)){
  ...
  # create ATA triangle using apply family function - this applies a function to a list
  #   of items without a loop
  ...
  # calculate ATA/ATU for remaining years, from oldest to least mature
